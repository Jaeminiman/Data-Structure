...
public class AssignmentGuide {
    ...
    public static void main(String[] args) {
        ...
        db.insert(new MovieDBItem("action","Man of Black"));
        db.insert(new MovieDBItem("boy","Man"));
        db.insert(new MovieDBItem("body","Mom"));
        db.insert(new MovieDBItem("body","Yesman"));
        db.insert(new MovieDBItem("boy","Man dark"));
        //db.delete(new MovieDBItem("boy","Man"));
        for (MovieList List : db.movies) {
            for (String val : List) {
      ...
      //db.search("an");
     // for (MovieDBItem List : db.search("")){
